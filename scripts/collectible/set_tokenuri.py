...
from scripts.helpfull_scripts import OPENSEA_URL, get_account, get_breed
dog_metadata_dic = {
...
def set_tokenURI(token_id, nft_contract, tokenURI):
    ...
    tx.wait(1)
    print(f"Awsome! You can wiew your NFT at {OPENSEA_URL.format(nft_contract.address, token_id)}")
